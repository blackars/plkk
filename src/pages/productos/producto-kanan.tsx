...
const products = [
{
  ...
  tasting: 'Notas de agave fresco, cítricos y un final ahumado equilibrado.',
  sizes: ['375 ml', '750 ml'],
  featured: false,
  description: 'KANAN Joven captura la esencia más pura del agave, un destilado que transmite la fuerza de la tierra y la tradición ancestral.',
  color: '#EEF2F8',
  accentColor: '#1B3A6B'
},
{
  id: 'rose',
  name: 'KANAN Mezcal Rosé',
  ...
  sizes: ['375 ml', '750 ml'],
  featured: true,
  description: 'KANAN Rosé es una expresión única que combina la tradición del mezcal con un delicado toque de frutos rojos.',
  color: '#FFF0F3',
  accentColor: '#C9A84C'
},
{
  id: 'anejo',
  name: 'KANAN Mezcal Añejo',
  ...
  tasting: 'Notas de vainilla, caramelo, madera tostada y agave maduro.',
  sizes: ['750 ml'],
  featured: false,
  description: 'KANAN Añejo es una expresión sofisticada, resultado de una maduración en barricas de roble que aporta complejidad y suavidad.',
  color: '#FDF6E3',
  accentColor: '#C9A84C'
}];
    ...
    <motion.div
      ...
      <div className="bg-white p-6">
        ...
        <div className="flex flex-wrap gap-2 mb-4">
          {p.sizes.map((s) =>
          <span key={s} className="px-3 py-1 border border-[#D4DCE8] text-[#5A7099] text-xs rounded-sm">{s}</span>
          )}
        </div>
...
export default function ProductoKananPage() {
  ...
  return (
    <>
      <Helmet>
        <title>KANAN Mezcal — Productos | Grupo Palenkke</title>
        <meta name="description" content="KANAN Mezcal: marca enfocada en preservar el valor cultural del mezcal a través de procesos tradicionales y una visión contemporánea." />
        <link rel="canonical" href="https://www.palenkke.org/productos/kanan" />
        <meta property="og:title" content="KANAN Mezcal — Productos | Grupo Palenkke" />
        <meta property="og:url" content="https://www.palenkke.org/productos/kanan" />
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-10 pt-40 pb-24 w-full">
          <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
            <motion.div variants={fadeUp} className="flex items-center gap-2 text-white/30 text-xs mb-8">
              ...
              <ChevronRight size={12} />
              <span className="text-white/60">{t('brand_pages.kanan.short_name')}</span>
            </motion.div>
            ...
            <motion.h1 variants={fadeUp} className="font-heading text-[clamp(44px,7vw,92px)] font-bold text-white leading-tight mb-6"
              dangerouslySetInnerHTML={{ __html: t('brand_pages.kanan.hero_heading') }}
            />
            <motion.p variants={fadeUp} className="text-white/55 text-lg leading-relaxed max-w-lg mb-10">
              {t('brand_pages.kanan.hero_sub')}
            </motion.p>

            <motion.div variants={stagger} className="flex flex-wrap gap-4">
              {[
              { Icon: Leaf, label: 'Agave Silvestre' },
              { Icon: Flame, label: 'Proceso Tradicional' },
              { Icon: Globe, label: 'Origen Oaxaca' },
              { Icon: Award, label: 'Calidad Premium' }].map(({ Icon, label }) =>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <InView>
              ...
              <motion.p variants={fadeUp} className="text-[#5A7099] text-base leading-relaxed mb-5">
                KANAN es una marca enfocada en preservar el valor cultural del mezcal a través de procesos tradicionales y una visión contemporánea. Cada botella representa el respeto por la tierra y la herencia ancestral de los maestros mezcaleros.
              </motion.p>
              <motion.p variants={fadeUp} className="text-[#5A7099] text-base leading-relaxed mb-8">
                Con tres variedades —Joven, Rosé y Añejo— KANAN ofrece una experiencia única que conecta la tradición con el paladar moderno.
              </motion.p>
            </InView>
            ...
            <motion.div
              ...
              <motion.div
                ...
                <span className="block font-heading text-2xl font-bold">Oaxaca</span>
