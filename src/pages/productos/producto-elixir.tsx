...
export default function ProductoElixirPage() {
  const { t } = useTranslation();
    ...
    <>
      <Helmet>
        ...
        <script type="application/ld+json">{JSON.stringify({
            ...
            url: 'https://www.palenkke.org/productos/elixir'
          })}</script>
      </Helmet>
        ...
        <div className="relative z-10 container mx-auto px-6 lg:px-10 pt-40 pb-24 w-full">
          <motion.div variants={stagger} initial="hidden" animate="visible" className="max-w-3xl">
            <motion.div variants={fadeUp} className="flex items-center gap-2 text-white/30 text-xs mb-8">
              ...
              <ChevronRight size={12} />
              <span className="text-white/60">{t('brand_pages.elixir.short_name')}</span>
            </motion.div>
